jQuery(function ($) {
  ...
  function AjaxExpander() {
    ...
    if ($('.ajax-load').length > 0) {
      ...
      $(document).on('click', '#project_close', function (event) {
        ...
        setTimeout(function () {
          $('.section .overlay').removeClass('disabled');
        }, (400));
        setTimeout(function () {
          $('.caption-content').removeClass('disabled');
        }, (1100));
        setTimeout(function () {
          $('.active .open-fullscreen').removeClass('disabled');
        }, (1100));
        setTimeout(function () {
  ...
  function Carousel() {
    ...
    if ($('.team-carousel').length > 0) {
      ...
      $('.team-member-carousel:nth-child(1)').on('mouseover', function () {
      ...
      $('.team-member-carousel:nth-child(2)').on('mouseover', function () {
        $('.team-member-carousel.active').removeClass('active');
        $('.team-images li.show-show').removeClass("show-show");
        $('.team-images li:nth-child(2)').addClass("show-show");
        $(this).addClass('active');
      })
      $('.team-member-carousel:nth-child(3)').on('mouseover', function () {
        $('.team-member-carousel.active').removeClass('active');
        $('.team-images li.show-show').removeClass("show-show");
        $('.team-images li:nth-child(3)').addClass("show-show");
        $(this).addClass('active');
      })
      $('.team-member-carousel:nth-child(4)').on('mouseover', function () {
        $('.team-member-carousel.active').removeClass('active');
        $('.team-images li.show-show').removeClass("show-show");
        $('.team-images li:nth-child(4)').addClass("show-show");
        $(this).addClass('active');
      })
      $('.team-member-carousel:nth-child(5)').on('mouseover', function () {
        $('.team-member-carousel.active').removeClass('active');
        $('.team-images li.show-show').removeClass("show-show");
        $('.team-images li:nth-child(5)').addClass("show-show");
        $(this).addClass('active');
      })
      $('.team-member-carousel:nth-child(6)').on('mouseover', function () {
        $('.team-member-carousel.active').removeClass('active');
        $('.team-images li.show-show').removeClass("show-show");
        $('.team-images li:nth-child(6)').addClass("show-show");
        $(this).addClass('active');
      })
      $('.team-member-carousel:nth-child(7)').on('mouseover', function () {
        $('.team-member-carousel.active').removeClass('active');
        $('.team-images li.show-show').removeClass("show-show");
        $('.team-images li:nth-child(7)').addClass("show-show");
        $(this).addClass('active');
      })
      $('.team-member-carousel:nth-child(8)').on('mouseover', function () {
        $('.team-member-carousel.active').removeClass('active');
        $('.team-images li.show-show').removeClass("show-show");
      ...
      $('.team-member-carousel:nth-child(1)').trigger('mouseover')
    ...
    if ($('#portfolio-wrap').length > 0) {
      ...
      $(window).on('resize', function () {
        ...
        if (winWidth >= 1466) {
          ...
          $('#portfolio-wrap').css({
            width: $('#portfolio-wrap').parent().width() + 10 + 'px'
          });
          $('#portfolio-wrap.no-gutter').css({
            width: $('#portfolio-wrap').parent().width() + 'px'
          });
